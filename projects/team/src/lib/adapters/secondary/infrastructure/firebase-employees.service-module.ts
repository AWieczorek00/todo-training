...
@NgModule({ imports: [AngularFirestoreModule],
  	declarations: [],
  	providers: [FirebaseEmployeesService, { provide: GETS_ALL_EMPLOYEE_DTO, useExisting: FirebaseEmployeesService }, { provide: GETS_ALL_EMPLOYEE_DTO, useExisting: FirebaseEmployeesService }, { provide: ADDS_EMPLOYEE_DTO, useExisting: FirebaseEmployeesService }, { provide: ADDS_EMPLOYEE_DTO, useExisting: FirebaseEmployeesService }, { provide: GETS_ONE_EMPLOYEE_DTO, useExisting: FirebaseEmployeesService }],
  	exports: [] })
